...
{-
    INV.REP.:
        * cada empleado esta asociado a un cuil unico 
        * un empleado puede pertenecer a mas de un sector y un sector puede tener mas de un empleado
        * si hay un empleado asignado a un sector en el primer map 
            dicho empleado tiene que estar en el segundo map asociado a un cuil.
-}
